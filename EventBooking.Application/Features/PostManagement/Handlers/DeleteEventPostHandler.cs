...
{
    internal class DeleteEventPostHandler : IRequestHandler<DeleteEventPostCommand, bool>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IUserContextService _userContextService;
        private readonly ITimeService _timeService;
        public DeleteEventPostHandler(IUnitOfWork unitOfWork, IUserContextService userContextService, ITimeService timeService)
        {
        ...
        public async Task<bool> Handle(DeleteEventPostCommand request, CancellationToken cancellationToken)
        {
            try
            {
                var existEvent = await _unitOfWork.EventPostRepository.GetByIdAsync(request.Id);
